<?php 
    if(isset($_GET['id_category'])){
        ...
        $query = query("SELECT * FROM category WHERE id_category='$id_kategori' ");
        $category_title = mysqli_fetch_array($query);
    }
?>
<div class="container">
    <div class="row push-from-top">
        <div class="col-md-12"><h1>Kategori Donasi : <?php echo $category_title['category_name'] ?></h1></div>
    </div>
    <div class="row push-from-top">
    <?php 
            $query = query("SELECT * FROM posts WHERE id_category = '$id_kategori'");
